...
namespace SmartWorkspaceManager.Application.Services
{
    public class WorkspaceService : IWorkspaceService
    {
        ...
        public async Task<WorkspaceInvitationResponse> CreateInvitationAsync(Guid workspaceId, InviteUserRequest request)
        {
            ...
            var existingInvitations = await _workspaceInvitationRepository.FindAsync(
            ...
            await _workspaceInvitationRepository.AddAsync(invitation);
            await _workspaceInvitationRepository.SaveChangesAsync();
